...
const schemaPath = path.join(root, "migrations-v2/0001_architecture_v2.sql");
...
const requiredTables = [
  ...
  "content_submissions", "submission_reviews", "verification_records", "releases", "release_items", "search_documents", "jobs",
];
