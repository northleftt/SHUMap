...
//
// 镜像 src/lib/dining/schedule.ts；两端规则由 miniprogram-dining.test.mjs 对照。
// 时区函数用固定 UTC+8 运算，兼容缺少完整 Intl 的小程序 JS 引擎。

import type { PublicDayType } from "../transit/types";
import type { ReleaseManifest } from "../release/types";
import type { CampusConfig, CampusKey, MerchantSummary } from "../release/types";
